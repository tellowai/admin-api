...
module.exports = {
  ...
  MEMORY_EXTRACTION_ENABLED: memoryBool('ADMIN_LLM_CHAT_MEMORY_EXTRACTION_ENABLED', 'extractionEnabled', false),
  ...
  MEMORY_EXTRACTION_MAX_PER_TURN: memoryInt('ADMIN_LLM_CHAT_MEMORY_EXTRACT_MAX', 'extractionMaxPerTurn', 2),
