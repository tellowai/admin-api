...
/** Hints the user is asking about Tellow business / analytics data. */
...
const REFUSAL_MESSAGE = 'I\'m limited to Tellow business analytics — ad spend, campaigns, installs, revenue, orders, and product metrics from our data. Ask something in that scope (e.g. "Meta spend yesterday" or "revenue by currency this month"), and I\'ll query and answer for you.';
