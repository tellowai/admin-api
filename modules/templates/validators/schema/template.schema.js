...
const customTextInputFieldSchema = Joi.object({
  ...
  /** How to transform user text for render (text + date/time fields; applied after formatting in workers). */
...
const updateTemplateSchema = Joi.object().keys({
  ...
  ae_rendering_engine: Joi.string().valid('alpha_mask', 'transparent_webm').optional(),
  transparent_webm_video_bucket: Joi.string().max(255).allow(null).optional(),
  transparent_webm_video_key: Joi.string().max(512).allow(null).optional(),
  bodymovin_json_bucket: Joi.string().max(255).allow(null).optional(),
  bodymovin_json_key: Joi.string().max(512).allow(null).optional(),
  hero_frame_index: Joi.number().integer().min(0).optional(),
  hero_preview_png_key: Joi.string().max(512).allow(null).optional(),
  hero_preview_png_bucket: Joi.string().max(128).allow(null).optional(),
  ...
  variant_label: Joi.string().max(100).allow(null, '').optional(),
  template_tag_ids: Joi.array().items(templateTagSchema).allow(null).optional(),
