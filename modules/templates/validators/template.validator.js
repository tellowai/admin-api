...
exports.validateInferTemplateMetadataData = function (req, res, next) {
  const payload = req.body;

  const payloadValidation = validationCtrl.validate(templateSchema.inferTemplateMetadataSchema, payload);
...
exports.validateReorderClipsData = function (req, res, next) {
  const payload = req.body;

  const payloadValidation = validationCtrl.validate(templateSchema.reorderClipsSchema, payload);
...
exports.validateAddClipData = function (req, res, next) {
  const payload = req.body || {};

  const payloadValidation = validationCtrl.validate(templateSchema.addClipSchema, payload);
