...
function callBackend(fbAccessToken) {
  ...
  let apiUrl = 'http://localhost:1234/auth/signin/facebook';

  // Optionally, you can perform additional actions based on the result
  if (!substringExists) {
      apiUrl = 'https://dev.api.dialogueapp.club/auth/signin/facebook';
  }
...
function callBackendAPI(data) {
  console.log(data,'data');
   ...
   // Log the result
   console.log(`Does the substring "${substring}" exist in the URL?`, substringExists);
   let apiUrl = 'http://localhost:1234/auth/signup/google';
 
   // Optionally, you can perform additional actions based on the result
   if (!substringExists) {
       apiUrl = 'https://dev.api.dialogueapp.club/auth/signup/google';
   }
